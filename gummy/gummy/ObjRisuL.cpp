...
void CObjRisuL::Init()
{
	...
	//当たり判定
	Hits::SetHitBox(this, m_px, m_py, 18.85, 18.85, ELEMENT_PLAYER, OBJ_RISUL, 1);
}
void CObjRisuL::Action()
{
	//主人公の位置を取得
	CObjRisuL* risu = (CObjRisuL*)Objs::GetObj(OBJ_RISUL);
	float hx = risu->GetX();
	float hy = risu->GetY();
...
void CObjRisuL::Draw()
{
	...
	Draw::Draw(3, &src, &dst, c, 0.0f); //左向きリス
