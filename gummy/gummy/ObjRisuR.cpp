...
void CObjRisuR::Init()
{
	...
	//当たり判定
	Hits::SetHitBox(this, m_px, m_py, 18.85, 18.85, ELEMENT_PLAYER, OBJ_RISUR, 1);
}
void CObjRisuR::Action()
{
	//主人公の位置を取得
	CObjRisuR* risu = (CObjRisuR*)Objs::GetObj(OBJ_RISUR);
	float hx = risu->GetX();
	float hy = risu->GetY();
...
void CObjRisuR::Draw()
{
	...
	Draw::Draw(2, &src, &dst, c, 0.0f); //右向きリス
