...
void CSceneMain::InitScene()
{
	...
	Draw::LoadImageW(L"右向き1.png", 2, TEX_SIZE_128);
	Draw::LoadImageW(L"左向き1.png", 3, TEX_SIZE_128);
	Draw::LoadImageW(L"前向き1.png", 4, TEX_SIZE_128);
	Draw::LoadImageW(L"後ろ姿1.png", 5, TEX_SIZE_128);
