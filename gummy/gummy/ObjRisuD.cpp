...
void CObjRisuD::Init()
{
	...
	//当たり判定
	Hits::SetHitBox(this, m_px, m_py, 18.85, 18.85, ELEMENT_PLAYER, OBJ_RISUD, 1);
}
void CObjRisuD::Action()
{
	//主人公の位置を取得
	CObjRisuD* risu = (CObjRisuD*)Objs::GetObj(OBJ_RISUD);
	float hx = risu->GetX();
	float hy = risu->GetY();
...
void CObjRisuD::Draw()
{
	...
	Draw::Draw(5, &src, &dst, c, 0.0f); //下向きリス
