...
void CObjRisuU::Init()
{
	...
	//当たり判定
	Hits::SetHitBox(this, m_px, m_py, 18.85, 18.85, ELEMENT_PLAYER, OBJ_RISUU, 1);
}
void CObjRisuU::Action()
{
	//主人公の位置を取得
	CObjRisuU* risu = (CObjRisuU*)Objs::GetObj(OBJ_RISUU);
	float hx = risu->GetX();
	float hy = risu->GetY();
...
void CObjRisuU::Draw()
{
	...
	Draw::Draw(4, &src, &dst, c, 0.0f); //前向きリス
